...
const routes: Routes = [
  ...
  { path: 'edit-services-value/:id', component: EditServicesValueComponent ,canActivate : [AuthGuardService]},
  { path: 'service/edit-service/:id', component: EditServiceComponent,canActivate : [AuthGuardService] },
  { path: 'edit-student/:id', component: EditStudentComponent ,canActivate : [AuthGuardService]},
  { path: 'students-list', component: StudentsListComponent ,canActivate : [AuthGuardService]},
  { path: 'get-all-services-size',component: ServicesSizeComponent,canActivate : [AuthGuardService]},
  { path:  'add-services-size',component: AddServicesSizeComponent,canActivate : [AuthGuardService]},
  { path:  'services/getAll',component: ServicesComponent,canActivate : [AuthGuardService]},
  { path: 'service/add-service',component:AddServiceComponent,canActivate : [AuthGuardService]},
  { path:  'pipes/getAll',component: PipeListComponent , canActivate : [AuthGuardService]},
  { path:  'pipe/add-pipe',component: AddPipeComponent,canActivate : [AuthGuardService]},
  { path: 'pipe/edit-pipe/:id', component: EditPipeComponent ,canActivate : [AuthGuardService]},
  { path: 'pipe/pipe-services',component:PipeServicesComponent,canActivate : [AuthGuardService]},
  { path: 'component/getAll',component:ServicesComponentComponent,canActivate : [AuthGuardService]},
  { path:  'component/add-component',component: AddServicesComponentComponent,canActivate : [AuthGuardService]},
  { path: 'component/edit-component/:id', component: EditServicesComponentComponent,canActivate : [AuthGuardService] },
  { path: 'project/getAll', component: ProjectListsComponent ,canActivate : [AuthGuardService]},
  { path: 'project/add-project', component: AddProjectsComponent ,canActivate : [AuthGuardService]},
  { path: 'project/edit-project/:id', component: EditProjectsComponent ,canActivate : [AuthGuardService]},
  { path: 'project_rev/getAll', component: ProjectRevisionsComponent,canActivate : [AuthGuardService]},
  { path: 'project_rev/add-project_rev', component: AddProjectRevisionsComponent,canActivate : [AuthGuardService]},
  { path: 'project_rev/edit-project_rev/:id/:id1', component: EditProjectRevisionsComponent,canActivate : [AuthGuardService]},
  { path: 'project_rev/getAll/:id', component: ProjectRevisionsComponent,canActivate : [AuthGuardService]},
  { path: 'project_rev/add-project_rev/:id', component: AddProjectRevisionsComponent,canActivate : [AuthGuardService]},
  { path: 'project_obj/edit-project_obj/:id/:id1', component: EditProjectObjectsComponent,canActivate : [AuthGuardService]},
  { path: 'project_obj/getAll/:id', component: ProjectObjectsComponent,canActivate : [AuthGuardService]},
  { path: 'project_obj/add-project_obj/:id', component: AddProjectObjectsComponent,canActivate : [AuthGuardService]},
  { path: 'project_sheet/edit-project_sheet/:id/:id1', component: EditProjectSheetsComponent,canActivate : [AuthGuardService]},
  //{ path: 'project_sheet/getAll/:id', component: ProjectSheetsComponent},
  { path: 'project_sheet/add-project_sheet/:id', component: AddProjectSheetsComponent,canActivate : [AuthGuardService]},
  { path: 'project_notes/edit-project_notes/:id/:id1', component: EditProjectNotesComponent,canActivate : [AuthGuardService]},
  { path: 'project_notes/getAll/:id', component: ProjectNotesComponent,canActivate : [AuthGuardService]},
  { path: 'project_notes/add-project_notes/:id', component: AddProjectNotesComponent,canActivate : [AuthGuardService]},
  { path: 'project_mech/edit-project_mech/:id/:id1', component: EditProjectMechComponent,canActivate : [AuthGuardService]},
  { path: 'project_mech/getAll/:id', component: ProjectMechComponent,canActivate : [AuthGuardService]},
  { path: 'project_mech/add-project_mech/:id', component: AddProjectMechComponent,canActivate : [AuthGuardService]},
  { path: 'project_sheet/getAll/:id', component: ProjectRegisterSheetComponent,canActivate : [AuthGuardService]},
  { path: 'generate-pdf/:id', component: GeneratePdfComponent,canActivate : [AuthGuardService]},
  ...
  { path: 'project-service-data/getAll/:id', component: ProjectServiceDataComponent,canActivate : [AuthGuardService]}, 
  { path: 'upload_templates', component: UploadTemplatesComponent,canActivate : [AuthGuardService]}, 
